...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_5f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0' => 'get15f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0Service',
            '2_5f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0' => 'get25f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0Service',
            ...
            'csv.reader.factory' => 'getCsv_Reader_FactoryService',
            ...
            'doctrine.writer.factory' => 'getDoctrine_Writer_FactoryService',
            ...
            'workflow.organizer' => 'getWorkflow_OrganizerService',
        );
        $this->privates = array(
            '1_5f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0' => true,
            '2_5f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_5f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0']) ? $this->services['1_5f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0'] : $this->get15f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_5f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0']) ? $this->services['2_5f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0'] : $this->get25f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0Service()) && false ?: '_'};
        }, 2));
    }
    ...
    /**
     * Gets the public 'converter' shared service.
     *
     * @return \AppBundle\Service\ValueConverterService
     */
    protected function getConverterService()
    {
        return $this->services['converter'] = new \AppBundle\Service\ValueConverterService();
    }

    /**
     * Gets the public 'csv.reader.factory' shared service.
     *
     * @return \Port\Csv\CsvReaderFactory
     */
    protected function getCsv_Reader_FactoryService()
    {
        return $this->services['csv.reader.factory'] = new \Port\Csv\CsvReaderFactory(0);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'importTest', 'user' => 'root', 'password' => 'root123', 'unix_socket' => '/tmp/mysql.sock', 'charset' => 'utf8mb4', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = DoctrineORMEntityManager_0000000075eee2e40000000019c6017715eb515d3e975f69865d2a9d7ae178b9::staticProxyConstructor(
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/vendor/gedmo/doctrine-extensions/lib/Gedmo/Translatable/Entity/MappedSuperclass'), 1 => ($this->targetDirs[3].'/src/AppBundle/Entity')));
        ...
        $d->setEntityNamespaces(array('Gedmo' => 'Gedmo\\Translatable\\Entity', 'AppBundle' => 'AppBundle\\Entity'));
    ...
    /**
     * Gets the public 'doctrine.writer.factory' shared service.
     *
     * @return \AppBundle\Service\DoctrineWriterFactory
     */
    protected function getDoctrine_Writer_FactoryService()
    {
        return $this->services['doctrine.writer.factory'] = new \AppBundle\Service\DoctrineWriterFactory(${($_ = isset($this->services['doctrine.orm.default_entity_manager']) ? $this->services['doctrine.orm.default_entity_manager'] : $this->get('doctrine.orm.default_entity_manager')) && false ?: '_'});
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_a16dff6e3dc7794ad3e8c760c4c3ef474060c5217f23778911a4228ea16dd1de');
    ...
    /**
     * Gets the public 'filter' shared service.
     *
     * @return \AppBundle\Service\ImportRuleService
     */
    protected function getFilterService()
    {
        return $this->services['filter'] = new \AppBundle\Service\ImportRuleService();
    }
    ...
    /**
     * Gets the public 'mapping' shared service.
     *
     * @return \AppBundle\Service\MappingService
     */
    protected function getMappingService()
    {
        return $this->services['mapping'] = new \AppBundle\Service\MappingService();
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('400ec7e8cb3b3befcfe56f0b8792b3863e7d74b0');
    }
    ...
    /**
     * Gets the public 'workflow.organizer' shared service.
     *
     * @return \AppBundle\Service\WorkflowOrganizer
     */
    protected function getWorkflow_OrganizerService()
    {
        return $this->services['workflow.organizer'] = new \AppBundle\Service\WorkflowOrganizer(${($_ = isset($this->services['filter']) ? $this->services['filter'] : $this->get('filter')) && false ?: '_'}, ${($_ = isset($this->services['converter']) ? $this->services['converter'] : $this->get('converter')) && false ?: '_'}, ${($_ = isset($this->services['mapping']) ? $this->services['mapping'] : $this->get('mapping')) && false ?: '_'}, ${($_ = isset($this->services['csv.reader.factory']) ? $this->services['csv.reader.factory'] : $this->get('csv.reader.factory')) && false ?: '_'}, ${($_ = isset($this->services['doctrine.writer.factory']) ? $this->services['doctrine.writer.factory'] : $this->get('doctrine.writer.factory')) && false ?: '_'});
    }

    /**
     * Gets the private '1_5f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get15f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0Service()
    {
        return $this->services['1_5f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_5f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get25f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0Service()
    {
        return $this->services['2_5f912393c2096a38e6cce73440247fcf9748d4c2041ec534671101970df727b0'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    public function getCache_App_RecorderInnerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['cache.app.recorder_inner'] = SymfonyComponentCacheAdapterFilesystemAdapter_0000000075eefd7e0000000019c6017715eb515d3e975f69865d2a9d7ae178b9::staticProxyConstructor(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
        ...
        $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('4mhxXepz6a', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cAyi4QN1Vs', 0, 'QeT8SUGZLw3zb8ALfHuHET', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('k3-j8Nq30E', 0, 'QeT8SUGZLw3zb8ALfHuHET', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('protJGVke2', 0, 'QeT8SUGZLw3zb8ALfHuHET', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a056dd2b87bf3.17302398');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '400ec7e8cb3b3befcfe56f0b8792b3863e7d74b0',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '400ec7e8cb3b3befcfe56f0b8792b3863e7d74b0',
...
class DoctrineORMEntityManager_0000000075eee2e40000000019c6017715eb515d3e975f69865d2a9d7ae178b9 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a056dd2eaf3a401831739 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a056dd2eaf43208207427 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a056dd2eaf13094581779 = [
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'getConnection', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->getConnection();
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'getMetadataFactory', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->getMetadataFactory();
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'getExpressionBuilder', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->getExpressionBuilder();
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'beginTransaction', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->beginTransaction();
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'getCache', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->getCache();
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'transactional', array('func' => $func), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->transactional($func);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'commit', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->commit();
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'rollback', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->rollback();
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'getClassMetadata', array('className' => $className), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->getClassMetadata($className);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'createQuery', array('dql' => $dql), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->createQuery($dql);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'createNamedQuery', array('name' => $name), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->createNamedQuery($name);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'createQueryBuilder', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->createQueryBuilder();
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'flush', array('entity' => $entity), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->flush($entity);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'clear', array('entityName' => $entityName), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->clear($entityName);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'close', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->close();
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'persist', array('entity' => $entity), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->persist($entity);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'remove', array('entity' => $entity), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->remove($entity);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'refresh', array('entity' => $entity), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->refresh($entity);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'detach', array('entity' => $entity), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->detach($entity);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'merge', array('entity' => $entity), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->merge($entity);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->copy($entity, $deep);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'getRepository', array('entityName' => $entityName), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->getRepository($entityName);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'contains', array('entity' => $entity), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->contains($entity);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'getEventManager', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->getEventManager();
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'getConfiguration', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->getConfiguration();
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'isOpen', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->isOpen();
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'getUnitOfWork', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->getUnitOfWork();
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'getProxyFactory', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->getProxyFactory();
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'initializeObject', array('obj' => $obj), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->initializeObject($obj);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'getFilters', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->getFilters();
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'isFiltersStateClean', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->isFiltersStateClean();
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'hasFilters', array(), $this->initializer5a056dd2eaf43208207427);

        return $this->valueHolder5a056dd2eaf3a401831739->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer5a056dd2eaf43208207427 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder5a056dd2eaf3a401831739) {
            $reflection = $reflection ?: new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder5a056dd2eaf3a401831739 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder5a056dd2eaf3a401831739->__construct($conn, $config, $eventManager);
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, '__get', ['name' => $name], $this->initializer5a056dd2eaf43208207427);

        if (isset(self::$publicProperties5a056dd2eaf13094581779[$name])) {
            return $this->valueHolder5a056dd2eaf3a401831739->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a056dd2eaf3a401831739;
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a056dd2eaf43208207427);
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, '__isset', array('name' => $name), $this->initializer5a056dd2eaf43208207427);
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, '__unset', array('name' => $name), $this->initializer5a056dd2eaf43208207427);
    ...
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, '__clone', array(), $this->initializer5a056dd2eaf43208207427);

        $this->valueHolder5a056dd2eaf3a401831739 = clone $this->valueHolder5a056dd2eaf3a401831739;
    }

    public function __sleep()
    {
        $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, '__sleep', array(), $this->initializer5a056dd2eaf43208207427);

        return array('valueHolder5a056dd2eaf3a401831739');
    }
    ...
    {
        $this->initializer5a056dd2eaf43208207427 = $initializer;
    }
    ...
    {
        return $this->initializer5a056dd2eaf43208207427;
    }
    ...
    {
        return $this->initializer5a056dd2eaf43208207427 && $this->initializer5a056dd2eaf43208207427->__invoke($this->valueHolder5a056dd2eaf3a401831739, $this, 'initializeProxy', array(), $this->initializer5a056dd2eaf43208207427);
    }
    ...
    {
        return null !== $this->valueHolder5a056dd2eaf3a401831739;
    }
    ...
    {
        return $this->valueHolder5a056dd2eaf3a401831739;
    }


}

class SymfonyComponentCacheAdapterFilesystemAdapter_0000000075eefd7e0000000019c6017715eb515d3e975f69865d2a9d7ae178b9 extends \Symfony\Component\Cache\Adapter\FilesystemAdapter implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a056dd2ee453979849049 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a056dd2ee45b938892441 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a056dd2ee43a263288499 = [
    ...
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, 'getItem', array('key' => $key), $this->initializer5a056dd2ee45b938892441);

        return $this->valueHolder5a056dd2ee453979849049->getItem($key);
    }
    ...
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, 'getItems', array('keys' => $keys), $this->initializer5a056dd2ee45b938892441);

        return $this->valueHolder5a056dd2ee453979849049->getItems($keys);
    }
    ...
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, 'save', array('item' => $item), $this->initializer5a056dd2ee45b938892441);

        return $this->valueHolder5a056dd2ee453979849049->save($item);
    }
    ...
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, 'saveDeferred', array('item' => $item), $this->initializer5a056dd2ee45b938892441);

        return $this->valueHolder5a056dd2ee453979849049->saveDeferred($item);
    }
    ...
    public function commit()
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, 'commit', array(), $this->initializer5a056dd2ee45b938892441);

        return $this->valueHolder5a056dd2ee453979849049->commit();
    }
    ...
    {
        $this->initializer5a056dd2ee45b938892441 || $this->valueHolder5a056dd2ee453979849049->__destruct();
    }
    ...
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, 'hasItem', array('key' => $key), $this->initializer5a056dd2ee45b938892441);

        return $this->valueHolder5a056dd2ee453979849049->hasItem($key);
    }
    ...
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, 'clear', array(), $this->initializer5a056dd2ee45b938892441);

        return $this->valueHolder5a056dd2ee453979849049->clear();
    }
    ...
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, 'deleteItem', array('key' => $key), $this->initializer5a056dd2ee45b938892441);

        return $this->valueHolder5a056dd2ee453979849049->deleteItem($key);
    }
    ...
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, 'deleteItems', array('keys' => $keys), $this->initializer5a056dd2ee45b938892441);

        return $this->valueHolder5a056dd2ee453979849049->deleteItems($keys);
    }
    ...
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, 'enableVersioning', array('enable' => $enable), $this->initializer5a056dd2ee45b938892441);

        return $this->valueHolder5a056dd2ee453979849049->enableVersioning($enable);
    }
    ...
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, 'setLogger', array('logger' => $logger), $this->initializer5a056dd2ee45b938892441);

        return $this->valueHolder5a056dd2ee453979849049->setLogger($logger);
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer5a056dd2ee45b938892441 = $initializer;
    ...
    public function __construct($namespace = '', $defaultLifetime = 0, $directory = null)
    {
        ...
        if (! $this->valueHolder5a056dd2ee453979849049) {
            $reflection = $reflection ?: new \ReflectionClass('Symfony\\Component\\Cache\\Adapter\\FilesystemAdapter');
            $this->valueHolder5a056dd2ee453979849049 = $reflection->newInstanceWithoutConstructor();
        ...
        $this->valueHolder5a056dd2ee453979849049->__construct($namespace, $defaultLifetime, $directory);
    }
    ...
    public function & __get($name)
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, '__get', ['name' => $name], $this->initializer5a056dd2ee45b938892441);

        if (isset(self::$publicProperties5a056dd2ee43a263288499[$name])) {
            return $this->valueHolder5a056dd2ee453979849049->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a056dd2ee453979849049;
    ...
    public function __set($name, $value)
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a056dd2ee45b938892441);
    ...
    public function __isset($name)
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, '__isset', array('name' => $name), $this->initializer5a056dd2ee45b938892441);
    ...
    public function __unset($name)
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, '__unset', array('name' => $name), $this->initializer5a056dd2ee45b938892441);
    ...
    public function __clone()
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, '__clone', array(), $this->initializer5a056dd2ee45b938892441);

        $this->valueHolder5a056dd2ee453979849049 = clone $this->valueHolder5a056dd2ee453979849049;
    }

    public function __sleep()
    {
        $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, '__sleep', array(), $this->initializer5a056dd2ee45b938892441);

        return array('valueHolder5a056dd2ee453979849049');
    }
    ...
    public function setProxyInitializer(\Closure $initializer = null)
    {
        $this->initializer5a056dd2ee45b938892441 = $initializer;
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer5a056dd2ee45b938892441;
    }
    ...
    public function initializeProxy() : bool
    {
        return $this->initializer5a056dd2ee45b938892441 && $this->initializer5a056dd2ee45b938892441->__invoke($this->valueHolder5a056dd2ee453979849049, $this, 'initializeProxy', array(), $this->initializer5a056dd2ee45b938892441);
    }
    ...
    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder5a056dd2ee453979849049;
    }
    ...
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5a056dd2ee453979849049;
    }
