...
/**
 * Adds the possibility to generate a fragment URI for a given Service.
 *
    ...
    private function checkNonScalar($values)
    {
        foreach ($values as $key => $value) {
            if (is_array($value)) {
                ...
                throw new \LogicException(sprintf('Service attributes cannot contain non-scalar/non-null values (value for key "%s" is not a scalar or null).', $key));
            }
        }
    }
}
