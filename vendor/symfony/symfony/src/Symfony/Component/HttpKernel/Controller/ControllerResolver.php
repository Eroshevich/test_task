...
class ControllerResolver implements ArgumentResolverInterface, ControllerResolverInterface
{
    ...
    public function getController(Request $request)
    {
        ...
        if (is_object($controller)) {
            ...
            throw new \InvalidArgumentException(sprintf('Service "%s" for URI "%s" is not callable.', get_class($controller), $request->getPathInfo()));
        }
    ...
    protected function doGetArguments(Request $request, $controller, array $parameters)
    {
        ...
        foreach ($parameters as $param) {
            if (array_key_exists($param->name, $attributes)) {
                ...
                throw new \RuntimeException(sprintf('Service "%s" requires that you provide a value for the "$%s" argument (because there is no default value or because there is a non optional argument after this one).', $repr, $param->name));
            }
        }
     ...
     *
     * @param string $controller A Service string
     *
