...
class InlineFragmentRendererTest extends TestCase
{
    ...
    {
        $resolver = $this->getMockBuilder('Symfony\\Component\\HttpKernel\\Service\\ControllerResolver')->setMethods(array('getController'))->getMock();
        $resolver
            ->expects($this->once())
    ...
    {
        $controllerResolver = $this->getMockBuilder('Symfony\\Component\\HttpKernel\\Service\\ControllerResolverInterface')->getMock();
        $controllerResolver
            ->expects($this->once())
            ->method('getController')
        ...
        $argumentResolver = $this->getMockBuilder('Symfony\\Component\\HttpKernel\\Service\\ArgumentResolverInterface')->getMock();
        $argumentResolver
            ->expects($this->once())
            ->method('getArguments')
