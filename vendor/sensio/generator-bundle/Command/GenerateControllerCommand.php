...
EOT
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $questionHelper->writeSection($output, 'Service generation');
    ...
    public function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        while (true) {
            $question = new Question($questionHelper->getQuestion('Service name', $input->getOption('controller')), $input->getOption('controller'));
            ...
            try {
                ...
                if (!file_exists($b->getPath().'/Service/'.$controller.'Service.php')) {
                    break;
                }

                $output->writeln(sprintf('<bg=red>Service "%s:%s" already exists.</>', $bundle, $controller));
            } catch (\Exception $e) {
                $output->writeln(sprintf('<bg=red>Bundle "%s" does not exist.</>', $bundle));
            }
        }
