...
class BundleGenerator extends Generator
{
    ...
    public function generateBundle(Bundle $bundle)
    {
        ...
        $this->renderFile('bundle/DefaultController.php.twig', $dir.'/Service/DefaultController.php', $parameters);
        $this->renderFile('bundle/DefaultControllerTest.php.twig', $bundle->getTestsDirectory().'/Service/DefaultControllerTest.php', $parameters);
