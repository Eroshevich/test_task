...
/**
 * Generates a Service inside a bundle.
 *
...
class ControllerGenerator extends Generator
{
    ...
    {
        $dir = $bundle->getPath();
        $controllerFile = $dir.'/Service/'.$controller.'Service.php';
        if (file_exists($controllerFile)) {
            throw new \RuntimeException(sprintf('Service "%s" already exists', $controller));
        }
        ...
        $this->renderFile('controller/Service.php.twig', $controllerFile, $parameters);
        $this->renderFile('controller/ControllerTest.php.twig', $dir.'/Tests/Service/'.$controller.'ControllerTest.php', $parameters);
    }
